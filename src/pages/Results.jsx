                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-semibold uppercase ${getResultColor(game.result)}`}>
                        {game.result}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#003865]">{game.score}</div>
